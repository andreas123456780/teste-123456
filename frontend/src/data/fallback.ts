...
export const FALLBACK_PRODUCTS: Product[] = [
  ...
  {
    id: "p-slim-black",
    name: "CAMISETA NAST SLIM PRETA",
    description:
      "Camiseta slim fit preta em algodão 30.1 penteado com print poético frontal em branco. Corte regular, caimento ajustado e etiqueta tecida NAST.",
    priceCents: 8990,
    pixPriceCents: 8541,
    category: "Camisetas",
    image: "slim-black.png",
    backImage: "slim-black.png",
    transparentImage: false,
    colors: ["preto"],
    sizes: ["P", "M", "G", "Baby Look"],
    tags: ["edição limitada"],
    stock: 20,
    stockBySize: { P: 5, M: 7, G: 5, "Baby Look": 3 },
  },
  {
    id: "p-slim-white",
    name: "CAMISETA NAST SLIM BRANCA",
    description:
      "Camiseta slim fit branca em algodão 30.1 penteado com print poético frontal em preto. Corte regular, caimento ajustado e etiqueta tecida NAST.",
    priceCents: 8990,
    pixPriceCents: 8541,
    category: "Camisetas",
    image: "slim-white.png",
    backImage: "slim-white.png",
  ...
  },
  {
    ...
    pixPriceCents: 9491,
    category: "Boxy",
    image: "boxy-black.png",
    backImage: "boxy-black.png",
    transparentImage: false,
    colors: ["preto"],
    sizes: ["P", "M", "G"],
    tags: ["boxy fit"],
  ...
  },
  {
    ...
    pixPriceCents: 9491,
    category: "Boxy",
    image: "boxy-white.png",
    backImage: "boxy-white.png",
    transparentImage: true,
    colors: ["branco"],
    sizes: ["P", "M", "G"],
    tags: ["boxy fit"],
